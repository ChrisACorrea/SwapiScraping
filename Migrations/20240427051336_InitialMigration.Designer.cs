...
namespace SwapiScraping.Migrations
{
    ...
    [Migration("20240427051336_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SwapiScraping.Models.Character", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SwapiScraping.Models.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SwapiScraping.Models.Planet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SwapiScraping.Models.Starship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SwapiScraping.Models.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CharacterMovie", b =>
                {
                    b.HasOne("SwapiScraping.Models.Character", null)
                        .WithMany()
                        .HasForeignKey("CharactersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SwapiScraping.Models.Movie", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MoviePlanet", b =>
                {
                    ...
                    b.HasOne("SwapiScraping.Models.Planet", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieStarship", b =>
                {
                    ...
                    b.HasOne("SwapiScraping.Models.Starship", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieVehicle", b =>
                {
                    ...
                    b.HasOne("SwapiScraping.Models.Vehicle", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SwapiScraping.Models.Character", b =>
                {
                    b.HasOne("SwapiScraping.Models.Planet", "Planet")
                        .WithMany("Characters")
